...
excerpt: 'a fully homomorphic encryption transpiler that allows developers to convert high-level code (e.g., C++) that works on unencrypted data into high-level code that operates on encrypted data'
date: 2021-06-14
venue: 'github/google/fully-homomorphic-encryption'
paperurl: 'https://eprint.iacr.org/2021/811.pdf'
---
