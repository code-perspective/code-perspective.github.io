...
---
 ...
 In this paper, we are analyzing the performance of Format Preserving Encryption (FIPS 74-8) over block ciphers such as AES, DES, 3DES, Blowfish on numeric data (credit cards numbers) with different keys.
